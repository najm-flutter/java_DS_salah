...
public class MainStackG {
    ...
    public static void run(Scanner in) {
        ...
        options.put(3, STACK_OPERATION.DELETE);
        options.put(4, STACK_OPERATION.DISPLAY);
    ...
    static void staticStack(Scanner in, HashMap<Integer, STACK_OPERATION> options) {
        ...
        StackG<Object> stack = new StackG<>(size);
        printSTStackOptions();
        int choice;
        while ((choice = in.nextInt()) != 0) {
            ...
            switch (options.getOrDefault(choice, STACK_OPERATION.DEFAULT)) {
                case PUSH:
                    ...
                    while (!stack.isFull()) {
                        ...
                        stack.push(Methods.choiseTypeT(in));
                    }
                    break;
                case POP:
                ...
                case DISPLAY:
                    ...
                    break;
                case DELETE:
                    stack.deleteItem(Methods.choiseTypeT(in));
                    break;
                default:
                    Messages.printInvalidOptionMessage();
                    break;
    ...
    public static void printSTStackOptions() {
        System.out.println("""
                \nchoice Operation
                     1. Push
                     2. Pop
